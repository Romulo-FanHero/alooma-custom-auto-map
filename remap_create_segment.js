                ...
                var autoMap = e => e.fields.forEach(f => {
                    ...
                    // metafields should NEVER be discarded
                        ...
                        if (
                            ...
                            (f.mapping.columnName && f.mapping.columnName.includes('snapshot_id')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('snapshot_id'))
                        ) {
                            f.mapping.columnType.type = 'BIGINT';
                            delete f.mapping.columnType.length;
                            delete f.mapping.columnType.truncate;
                    ...
                    if (!f.mapping.columnType.type.toLowerCase().includes('numeric')) {
