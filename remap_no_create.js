            ...
            .then(evt => {
                ...
                var autoMap = e => e.fields.forEach(f => {
                    ...
                    // metafields should NEVER be discarded
                        ...
                        if (
                            (f.mapping.columnName && f.mapping.columnName.includes('doc_id')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('doc_id')) ||
                            ...
                            (f.mapping.columnName && f.mapping.columnName.includes('event_type')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('event_type')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('event_type')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('event_type')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('uuid')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('uuid')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('input_label')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('input_label')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('input_type')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('input_type')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('input_id')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('input_id')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('schema_url')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('schema_url')) ||
                        ...
                        if (
                            ...
                            (f.mapping.columnName && f.mapping.columnName.includes('width')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('width')) ||
                            (f.mapping.columnName && f.mapping.columnName.includes('height')) ||
                            (f.mapping.fieldName && f.mapping.fieldName.includes('height')) ||
